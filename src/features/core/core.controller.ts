...
export class CoreController {
	...
	@ApiOkResponse({ description: "Returns navigation configuration used by the UI" })
	...
	@ApiOkResponse({ description: "Returns created portfolio entry or conflict message" })
	...
	@ApiOkResponse({ description: "Returns list of portfolio entries", type: [Portoflio] })
	async getPortfolio() {
